...
function bewerkTitel() {
  var titelbewerken = prompt("TITEL AANPASSEN");
  if (titelbewerken === "") {
...
function bewerkText() {
  ...
  var textbewerken = prompt("AANPASSEN") // function scope
  if (textbewerken === "") {
    localStorage.setItem("text", textbewerken);
...
function bewerkText1() {
  ...
  var text1bewerken = prompt("AANPASSEN");
  if (text1bewerken === "") {
...
function iframe() {
  var youtube = prompt("Url van filmpje");
